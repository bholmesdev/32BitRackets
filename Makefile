...
OFILES = gba.o font.o logic.o graphics.o main.o images/tennisCourtBackground.o images/rulesScreen.o images/winnerScreen.o images/splashScreen.o sprites.o
